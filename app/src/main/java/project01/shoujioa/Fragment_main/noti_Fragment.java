...
public class noti_Fragment extends Fragment {
    ...
    private String URL= HttpUtils.URL+"tzggapp/app_tzggdblist";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=View.inflate(getContext(), R.layout.noti_ci_one,null);
        initview();
                    ...
                    if(!message.equals("success")){
                        ...
                        noti_ci_one_adepter.setOnDeleteListener(new noti_ci_one_adepter.OnDeleteListener() {
                            ...
                            public void delete(String id) {
                                Intent intent=new Intent(getContext(),noti_ci_main_one.class);
