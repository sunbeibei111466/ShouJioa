...
import project01.shoujioa.main_new_inten.noti_ci_main;

public class noti_Fragmenttwo extends Fragment {
    private View view;
    private String URL= HttpUtils.URL+"tzggapp/app_tzgglist";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=View.inflate(getContext(), R.layout.noti_ci_two,null);
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    if(!message.equals("success")){
                        ...
                        noti_ci_two_adepter=new noti_ci_two_adepter(getContext(),arraylist,"3");
                        ...
                        noti_ci_two_adepter.setOnDeleteListener(new noti_ci_two_adepter.OnDeleteListener() {
                            ...
                            public void delete(String id) {
                                Intent intent=new Intent(getContext(),noti_ci_main.class);
