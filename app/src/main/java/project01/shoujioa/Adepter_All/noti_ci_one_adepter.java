...
public class noti_ci_one_adepter extends RecyclerView.Adapter<noti_ci_one_adepter.MY> {
    Context context;
    private List<new_String> arrayList=new ArrayList<>();

    public noti_ci_one_adepter(Context context, List<new_String> arrayList) {
    ...
    public MY onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        noti_ci_one_adepter.MY My=new noti_ci_one_adepter.MY(LayoutInflater.from(
