...
public class File_upload_adepter_two extends RecyclerView.Adapter<File_upload_adepter_two.MY> {
    Context context;
    private ArrayList<new_String> arrayList=new ArrayList<>();

    public File_upload_adepter_two(Context context, ArrayList<new_String> arrayList) {
    ...
    public MY onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
      MY My=new MY(LayoutInflater.from(
                context).inflate(R.layout.file_fragmentwo_main, viewGroup,
                false));
        return My;
    }
    ...
    public class MY extends RecyclerView.ViewHolder {
        ...
        public MY(@NonNull View itemView) {
            ...
            csr=itemView.findViewById(R.id.csr);
        }
    }
